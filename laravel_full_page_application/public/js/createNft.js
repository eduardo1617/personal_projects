...
var imageInput = document.querySelector('.image__input');
var imagePreview = document.querySelector('.card-img-container .image__preview');
var imageURL = document.querySelector('.input__file--url');
var price = document.querySelector('.price');
var title = document.querySelector('.title');
var bidPrice = document.querySelector('.bid-price');
var nftTitle = document.querySelector('.nft-title');
