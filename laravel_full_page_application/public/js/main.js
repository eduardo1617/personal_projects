...
/*!******************************!*\
  ...
  \******************************/
var nftCardsContainer = document.querySelector(".live-auctions-cards-container");
var nftCards = document.querySelectorAll(".live-auctions-cards .card");
var btnContainer = document.querySelector(".slide-btn-container");
var leftBtn = document.querySelector(".left-row");
var rightBtn = document.querySelector(".right-row");
rightBtn.addEventListener("click", function () {
  nftCardsContainer.scrollLeft += nftCardsContainer.offsetWidth + 30;
  var current = document.querySelector(".slide-btn-container .current");
...
var bullets = Math.floor(nftCards.length / 4);
